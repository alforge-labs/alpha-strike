...
Thanks for your interest in contributing to `alpha-strike`! Bug reports, feature requests, documentation improvements, and code contributions are all welcome.
...
```bash
# 1. Fork & clone
git clone https://github.com/<your-username>/alpha-strike.git
cd alpha-strike
...
When a third language (e.g., Chinese, Korean) is added in the future, you only need to add `zh` / `ko` fields to the `STRINGS` map. We recommend gradually migrating shared strings to the map ([Issue #151](https://github.com/alforge-labs/alpha-strike/issues/151) tracks the phased migration).
...
- **Bug reports / feature requests**: [GitHub Issues](https://github.com/alforge-labs/alpha-strike/issues)
- **Questions / discussions**: [GitHub Discussions](https://github.com/alforge-labs/alpha-strike/discussions) (if enabled)
