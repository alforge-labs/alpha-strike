...
- CHANGELOG を v1.2.0 に更新



### バグ修正

- OpenD 障害でイベントループが凍結して取引と監視が止まるのを解消する (#140)
...
- CHANGELOG を v1.1.0 に更新


- 互換台帳へ v1.1.0 の本番反映結果を追記 (#134)



### バグ修正

- /health/ready で OANDA_ENV の妥当性まで検証する (#135)



### 新機能

- TradingView シグナル途絶を検知して通知する watchdog を追加 (#136)
...
- CHANGELOG を v1.0.4 に更新



### 新機能

- 起動時に events ディレクトリへバージョンメタを書き出す (#131)
